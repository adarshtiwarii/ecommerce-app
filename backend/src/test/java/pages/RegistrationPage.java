...
public class RegistrationPage {
    ...
    // Password locator
    private By password = By.cssSelector("input[placeholder='Password (min 8 characters)']");

    // Confirm Password locator
    private By confirmPassword = By.cssSelector("input[placeholder='Confirm Password']");
    ...
    public void enterPassword(String pwd) {
        ...
        System.out.println("Password Elements Found: "
                + driver.findElements(password).size());
