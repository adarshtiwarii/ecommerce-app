                  ...
                  <div className="grid gap-5 lg:grid-cols-2">
                    ...
                    <div className={panelClass}>
                      ...
                      <div className="mt-4 space-y-3">
                        ...
                        <button onClick={forgotPassword} className="rounded-full border border-orange-500/40 px-5 py-3 font-black text-orange-400">Generate reset token</button>
                        <input value={resetForm.token} onChange={e => setResetForm({ ...resetForm, token: e.target.value })} className="w-full rounded-md border border-white/10 bg-[#1E1E1E] px-3 py-3 text-base text-white placeholder-white/30" placeholder="Reset token" />
